...
namespace ProjectPRN221.Pages.Authentication
{
    public class ForgotPasswordModel : PageModel
    {
		...
		public ForgotPasswordModel(IDistributedCache cache)
		{
			_cache = cache;
		}
		...
		public async Task<IActionResult> OnPost()
		{
			...
			sendToken();
			ViewData["error"] = "Your OTP is send to your email to confirm!";
			return Page();
		}
		...
		private void sendToken()
		{
			...
			EmailService.Send(txtEmail, "Your Token In Project PRN To confirm forgot password:", "Your OTP : " + token + ". This code is expired after 10 minutes");
